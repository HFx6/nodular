...
// theme.ts. Only the three token colors the old CodeTint mapped (keyword,
// string, number) are styled; everything else inherits ink.
...
export const paperThemeRail = EditorView.theme({
  ...
  "&": { ...shared["&"], height: "100%" },
  ".cm-gutters": { backgroundColor: "transparent", color: C.faint, border: "none", borderRight: `1px solid ${C.edge}`, fontSize: "10px" },
