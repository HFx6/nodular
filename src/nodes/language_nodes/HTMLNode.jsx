		...
		<div className={`${data.label}-code-container ${data.label}-node`}>
			...
			<div className={`${data.label}-code-body`}>
				<div style={{ display: "none" }}>
					<h1>DooM</h1>
					<p>
						A wasm32 port of 1997 linuxdoom-1.10 with minimal
					...
					<p id="focushint"></p>
					<p>
						Use <button id="enterButton">&#x23CE;</button> to start
						the game, arrow keys{" "}
						<button id="leftButton">&#x2190;</button>{" "}
						<button id="upButton">&#x2191;</button>{" "}
						<button id="downButton">&#x2193;</button>{" "}
						<button id="rightButton">&#x2192;</button> to move,
						<button id="ctrlButton">ctrl</button> to shoot, spacebar{" "}
						<button id="spaceButton">
							&nbsp;&nbsp;&nbsp;&nbsp;
						</button>{" "}
						to open gates,
						<button id="altButton">alt</button> and arrow keys to
						strafe (if your browser does not handle these keys
						otherwise). On mobile (and mobile only) touch the
						buttons above. Yeah, I'm not good a UX design.
					</p>
